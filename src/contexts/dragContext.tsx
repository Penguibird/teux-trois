...
export const { ObserverContext: DragObserverContext, useObserverContext: useDragObserverContext, ObserverContextProvider: DragObserverContextProvider } = generateObserverContext<MyDragEvent>()